...
export default function CopyDiscord({
  ...
  return (
    <button
      ...
      className="inline-flex cursor-pointer items-center gap-1.5 text-sm lowercase text-[#a3a3a3] transition-colors duration-150 ease-in-out hover:text-[#ededed] focus-visible:text-[#ededed] motion-reduce:transition-none"
    >
